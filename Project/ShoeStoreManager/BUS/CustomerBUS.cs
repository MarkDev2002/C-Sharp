...
namespace BUS
{
    public class CustomerBUS
    {
		...
		public string SetAutoID()
		{
			string userID = "CUS";
			int num = 0;
			List<CustomerDTO> list = CustomerBUS.Instance.GetList();
			string lastID = list[list.Count - 1].CustomerID1.ToString();
		...
		public string SetAutoIDForGuest()
		{
			string userID = "GST";
			int num = 0;
			List<CustomerDTO> list = CustomerBUS.Instance.GetList();
		...
		public string AddGuest(string id)
		{
			cusDAO.AddGuest(id);
			return "success";
		}
