...
namespace BUS
{
    public class StaffBUS
    {
		...
		public List<StaffDTO> GetListUserIDsFromStaff(string staffID)
		{
			listStaffDTO = new List<StaffDTO>();
			listStaffDTO = staffDAO.GetAllAccountOfStaff(staffID);
        ...
        public bool AddAccount(StaffDTO staffDTO)
        {
            return this.staffDAO.UpdateAddAccount(staffDTO);
        }
