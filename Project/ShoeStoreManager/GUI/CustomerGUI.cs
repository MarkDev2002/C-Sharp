...
namespace GUI
{
    ...
    {
        public static CustomerGUI _instance;

        public static CustomerGUI Instance
        {
            get { if (_instance == null) _instance = new CustomerGUI(); return _instance; }
        ...
        {
            InitializeComponent();
			txtID_item.Text = CustomerBUS.Instance.SetAutoID();
        ...
        private void guna2Button2_Click(object sender, EventArgs e)
        {
            ...
            if (kq == "error_phone")
            {
                MessageBox.Show("Sai định dạng số điện thoại (10 chữ số từ 0-9)", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            if (kq == "error_CusId")
            {
