...
namespace GUI
{
    public partial class ListProduct : KryptonForm
    {
        ...
        {
            dtgv.DataSource = productBUS.GetListByAmount();
            ChangeHeader();
            DisableColumn();
        ...
        private void dtgv_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
				_sale.dtgv.Rows.Add(
					billDetailDTO.ProductID,
					billDetailDTO.ProductName,
					billDetailDTO.Quantity,
					billDetailDTO.Inventory,   // Fix inventory
					billDetailDTO.UnitPrice,
					billDetailDTO.Quantity * billDetailDTO.UnitPrice
				);
			}
