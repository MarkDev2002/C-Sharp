    ...
    public partial class Product : Form
    {
        ...
        private void ToExcel(DataGridView dataGridView1, string fileName)
        {
            ...
            try
            {
				...
				for (int i = 8; i < dataGridView1.ColumnCount-2; i++)
				{
				...
				for (int i = 0; i < dataGridView1.RowCount; i++)
                {
                    ...
                    for(int k=8;k< dataGridView1.ColumnCount-2; k++)
                    {
						worksheet.Cells[i + 2, k] = dataGridView1.Rows[i].Cells[k].Value.ToString();
					}
				}
