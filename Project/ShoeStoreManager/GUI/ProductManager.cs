...
namespace GUI
{
    public partial class ProductManager : KryptonForm
    {
		...
		private bool ValidateData()
		{
			...
			{
				MessageBox.Show("Chưa chọn size sản phẩm");
				return false;
			}
			...
			{
				MessageBox.Show("Chưa chọn màu sản phẩm");
				return false;
			}

			if (cbxCategory.SelectedItem == null)
			{
				MessageBox.Show("Chưa thêm loại sản phẩm");
				return false;
			}

			if (cbxProducer.SelectedItem == null)
			{
				MessageBox.Show("Chưa chọn nhà sản xuất của sản phẩm");
				return false;
			}
			...
			{
				MessageBox.Show("Chưa thêm hình ảnh của sản phẩm");
				return false;
			}
