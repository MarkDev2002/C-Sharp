...
namespace GUI
{
    public partial class RoleFuncGUI : Form
    {
        ...
        public void LoadDataListRole()
        {
            ...
            bindingSource.DataSource = RoleBUS.Instance.GetListWithoutDefault();
        ...
        public void LoadComboBoxRole()
        {
            ...
            List<RoleDTO> role = RoleBUS.Instance.GetListWithoutDefault();
            int size = role.Count;
        ...
        private void FormRole_Load(object sender, EventArgs e)
        {
            ...
            updateRole.Image = Resources.icons8_pencil_drawing_30;
            ...
            updateFunc.Image = Resources.icons8_pencil_drawing_30;
