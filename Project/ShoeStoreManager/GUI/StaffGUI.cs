...
namespace GUI
{
    public partial class StaffGUI : Form
    {
        ...
        private void Staff_Load(object sender, EventArgs e)
        {
            ...
            dtgv.Columns[6].Width = 100; // address
            dtgv.Columns[7].Width = 350;
            dtgv.Columns[8].Width = 150; // avatar
            ChangeHeader();
        }
        ...
        private void dtgv_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (colName == "Data1")
            {
                ...
                p.cbxUserID.Text = dtgv.Rows[e.RowIndex].Cells["UserID"].Value.ToString();
		...
		private void btnDeleteAccFromStaff_Click(object sender, EventArgs e)
		{
			RemoveFromStaff removeAcc = new RemoveFromStaff();
			removeAcc.ShowDialog();
		}
	}
}
